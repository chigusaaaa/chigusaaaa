...
- 🧠 AI layer-nya provider-agnostic — default **Ollama** (jalan di CPU karena RX 580 belum kesentuh ROCm), tapi bisa nyambung ke OpenAI-compatible API juga.
- 🐳 Semua project dikontainerin — Docker + Lazydocker jadi teman sehari-hari.
- 🎮 Sesekali ngoprek gaming di Linux juga (Proton, launcher custom, dkk).
